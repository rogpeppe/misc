...
func TestSetLEDBrightness(t *testing.T) {
	...
	var states = []struct {
		...
		{0, 5, []byte{0x07, 5, 0x16, 0xFF}},
		{1, 10, []byte{0x08, 10, 0x16, 0xFF}},
		{2, 15, []byte{0x09, 15, 0x16, 0xFF}},
		{3, 20, []byte{0x06, 20, 0x16, 0xFF}},
		{4, 25, []byte{0x05, 25, 0x16, 0xFF}},
		{5, 30, []byte{0x0A, 30, 0x16, 0xFF}},
		{6, 35, []byte{0x12, 35, 0x16, 0xFF}},
		{7, 40, []byte{0x11, 40, 0x16, 0xFF}},
		{8, 45, []byte{0x10, 45, 0x16, 0xFF}},
		{9, 50, []byte{0x0E, 50, 0x16, 0xFF}},
		{10, 55, []byte{0x0C, 55, 0x16, 0xFF}},
		{11, 60, []byte{0x0B, 60, 0x16, 0xFF}},
		{12, 65, []byte{0x01, 65, 0x16, 0xFF}},
		{13, 70, []byte{0x02, 70, 0x16, 0xFF}},
		{14, 75, []byte{0x03, 75, 0x16, 0xFF}},
		{15, 80, []byte{0x04, 80, 0x16, 0xFF}},
		{16, 85, []byte{0x0F, 85, 0x16, 0xFF}},
		{17, 90, []byte{0x0D, 90, 0x16, 0xFF}},
	}
