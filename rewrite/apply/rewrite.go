...
func Apply(root ast.Node, pre, post ApplyFunc) ast.Node {
	...
	// Fashion a parent for the root node.
	parent := struct {
		ast.Node
	}{root}
	a := &application{pre: pre, post: post}
	a.apply(&parent, "Node", -1, root)
	return parent.Node
}
...
func (c *ApplyCursor) HasIndex() bool { return c.index != -1 }
...
func (a *application) apply(parent ast.Node, name string, index int, n ast.Node) (newindex, incr int) {
	// (at least) the following things can be nil:
	// *ast.BasicLit, parent *ast.Field.Tag
	// *ast.CommentGroup, parent *ast.Field.Comment
	// *ast.CommentGroup, parent *ast.Field.Doc
	// *ast.CommentGroup, parent *ast.File.Doc
	// *ast.CommentGroup, parent *ast.FuncDecl.Doc
	// *ast.CommentGroup, parent *ast.GenDecl.Doc
	// *ast.CommentGroup, parent *ast.ImportSpec.Comment
	// *ast.CommentGroup, parent *ast.ImportSpec.Doc
	// *ast.CommentGroup, parent *ast.TypeSpec.Comment
	// *ast.CommentGroup, parent *ast.TypeSpec.Doc
	// *ast.CommentGroup, parent *ast.ValueSpec.Comment
	// *ast.CommentGroup, parent *ast.ValueSpec.Doc
	// *ast.FieldList, parent *ast.FuncDecl.Recv
	// *ast.FieldList, parent *ast.FuncType.Results
	// *ast.Ident, parent *ast.BranchStmt.Label
	// *ast.Ident, parent *ast.ImportSpec.Name
	// <nil>, parent *ast.ArrayType.Len
	// <nil>, parent *ast.CompositeLit.Type
	// <nil>, parent *ast.IfStmt.Else
	// <nil>, parent *ast.IfStmt.Init
	// <nil>, parent *ast.RangeStmt.Value
	// <nil>, parent *ast.SliceExpr.Low
	// <nil>, parent *ast.SliceExpr.Max
	// <nil>, parent *ast.SwitchStmt.Init
	// <nil>, parent *ast.TypeAssertExpr.Type
	// <nil>, parent *ast.TypeSwitchStmt.Init
	// <nil>, parent *ast.ValueSpec.Type
	if n == nil {
		return
	}
	...
	if !a.run(a.pre, &cursor) {
		return cursor.index, cursor.incr
	}
...
func (a *application) run(f ApplyFunc, c *ApplyCursor) bool {
	if f == nil {
		return true
	}
	a.cursor = *c
