// Package breader provides an io.Reader that wraps another
// io.Reader, reading as much data as possible and buffering
// it in a temporary file, regardless of how slow the wrapping
// reader is read from.
import (
	"io"
	"io/ioutil"
